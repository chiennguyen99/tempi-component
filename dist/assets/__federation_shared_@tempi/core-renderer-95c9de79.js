...
import { P as PropTypes, j as jsxRuntimeExports, d as dayjs, c as clsx, G as Global, g as get, s as set } from '../clsx.m-40b90372-1726417061899.js';
...
height: 72px;
width: 72px;`;
const StyledPrevButton = styled$2.button`
  ${StyledButton}
  inset: 20px 20px
`;
const StyledNextButton = styled$2.button`
  ${StyledButton}
  right: 20px;
`;
const StyledButtonUnzoom = styled$2.button`
  position: absolute;
  cursor: pointer;
...
const funcWrapperImage = ({ commonStyle }) => `
  ...
  `;
const StyledImageWrapperDiv = styled$1.div(funcWrapperImage);
const StyledImageWrapperPicture = styled$1.picture(funcWrapperImage);
...
const PlaceholderImage = styled$1.img`
  width: 100%;
  height: 100%;
  position: absolute;
  left: 0;
...
const StyledYtb = styled(YouTube_default)`
  iframe {
    position: absolute;
    top: 50%;
    left: 50%;
