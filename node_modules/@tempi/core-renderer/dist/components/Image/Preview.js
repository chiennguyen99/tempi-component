...
const Preview = ({
  ...
  const [showMask, setShowMask] = React.useState(open);
  const [showContent, setShowContent] = React.useState(open);
  const [previewPosition, setPreviewPosition] = React.useState();
  const [prevBodyAttrs, setPrevBodyAttrs] = React.useState({});
  const { images, currentIndex, setCurrentIndex } = PreviewGroupContext.usePreviewGroup();
  React.useEffect(() => {
    if (!images)
      return;
    if (open) {
  ...
  const [imgProps, imgApi] = web.useSpring(() => {
  ...
  const nextButton = currentIndex < (images == null ? void 0 : images.length) - 1 && /* @__PURE__ */ jsxRuntime.jsx(StyledNextButton, {
  ...
  const prevButton = currentIndex > 0 && /* @__PURE__ */ jsxRuntime.jsx(StyledPrevButton, {
  ...
  const unzoomButton = /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, {
    children: /* @__PURE__ */ jsxRuntime.jsx(StyledButtonUnzoom, {
      type: "button",
      children: /* @__PURE__ */ jsxRuntime.jsx("svg", {
        "aria-hidden": "true",
  ...
  return rendered ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [
      ...
      reactDom.createPortal(
        /* @__PURE__ */ jsxRuntime.jsxs("div", {
          children: [
            showMask && /* @__PURE__ */ jsxRuntime.jsx(MaskSpring, {
              style: props
            }),
            /* @__PURE__ */ jsxRuntime.jsxs(Content, {
              ...
              children: [
                operations,
                /* @__PURE__ */ jsxRuntime.jsx(ImageSpring, {
                  ...
                  onLoad: (e) => {
                    if (!previewPosition)
                      ...
                      }, getOffset.getOffset(e.currentTarget)));
                  }
                })
              ]
            })
...
const Mask = styled__default["default"].div`
  ...
  pointer-events: none;
`;
const MaskSpring = web.animated(Mask);
...
const Image = styled__default["default"].img`
  ...
  cursor: zoom-out;
`;
const ImageSpring = web.animated(Image);
const StyledButton = `
position: absolute;
cursor: pointer;
z-index: 1;
...
height: 72px;
width: 72px;`;
const StyledPrevButton = styled__default["default"].button`
  ${StyledButton}
  inset: 20px 20px
`;
const StyledNextButton = styled__default["default"].button`
  ${StyledButton}
  right: 20px;
`;
const StyledButtonUnzoom = styled__default["default"].button`
  position: absolute;
  cursor: pointer;
