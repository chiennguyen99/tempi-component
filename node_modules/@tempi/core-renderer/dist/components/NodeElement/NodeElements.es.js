...
const NodeElement = (_a) => {
  ...
  const _a2 = useStore(), { content, ssrData, componentDict, mappingDynamicSlots } = _a2, configs = __objRest(_a2, ["content", "ssrData", "componentDict", "mappingDynamicSlots"]);
  return useMemo(() => {
    var _a3, _b2;
    ...
    if ((_b2 = nodeData == null ? void 0 : nodeData.children) == null ? void 0 : _b2.length) {
      children = nodeData.children.map((childId) => /* @__PURE__ */ jsx(NodeElement, {
        id: childId
      }, childId));
    }
