...
var store = require('../editor/store.js');
...
const getTestNode = (parentNode) => {
  ...
  const validParentNode = createNode.createNode(cloneDeep__default["default"](parentNode));
...
const createTestState = (state = {}) => {
  ...
  return __spreadProps(__spreadValues(__spreadValues({}, store.editorInitialState), state), {
    nodes: rootNode ? createTestNodes(rootNode) : {},
    events: __spreadValues(__spreadValues({}, store.editorInitialState.events), events || {})
  });
};
