import { isChromium, isLinux } from '@tempi/dnd-utils';
import isFunction from 'lodash.isfunction';
import React from 'react';
import { CoreEventHandlers } from './CoreEventHandlers.es.js';
import { Positioner } from './Positioner.es.js';
import { createShadow } from './createShadow.es.js';

const _DefaultEventHandlers = class extends CoreEventHandlers {
  constructor() {
    super(...arguments);
...
DefaultEventHandlers.forceSingleDragShadow = isChromium() && isLinux();

export { DefaultEventHandlers };
