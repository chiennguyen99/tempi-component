...
function useNode(collect) {
  const _a = useInternalNode.useInternalNode(collect), { id, related, actions, inNodeContext, connectors } = _a, collected = __objRest(_a, ["id", "related", "actions", "inNodeContext", "connectors"]);
  return __spreadProps(__spreadValues({}, collected), {
    actions,
    id,
    related,
    setProp: (cb, throttleRate) => {
      dndUtils.deprecationWarning("useNode().setProp()", {
