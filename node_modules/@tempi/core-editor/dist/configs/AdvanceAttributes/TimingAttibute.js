...
var TimingConfig = require('../TimingConfig/TimingConfig.js');
...
const TimingAttributes = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(TimingConfig.TimingConfig, __spreadValues({}, {
    startTime,
    endTime,
    ruleRepeat,
    date,
...
exports.TimingAttributes = TimingAttributes;
