...
const RadioConfig = (props) => {
  const _a = props, { formItemProps, radioGroupProps, propKey, separateDevice } = _a, rest = __objRest(_a, ["formItemProps", "radioGroupProps", "propKey", "separateDevice"]);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(FormItem.FormItem, __spreadProps(__spreadValues({}, formItemProps), {
    children: /* @__PURE__ */ jsxRuntime.jsx(antd.Radio.Group, __spreadValues(__spreadValues({
      value: prop,
      onChange: (e) => setProp(e.target.value)
    }, radioGroupProps), rest))
  }));
};
