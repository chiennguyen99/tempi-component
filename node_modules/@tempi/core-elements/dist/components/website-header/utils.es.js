...
import { DEFAULT_WEBSITE_HEADER_DESKTOP } from './constants.es.js';
...
const calculateGrid = (props) => {
  ...
  const width = 1240;
  const menuPosition = ((_a = props == null ? void 0 : props.menuConfig) == null ? void 0 : _a.align) || Alignment.right;
  ...
  const spaceBetweenMenu = ((_e = props == null ? void 0 : props.logoConfig) == null ? void 0 : _e.spacingWithMenu) || DEFAULT_WEBSITE_HEADER_DESKTOP.logoConfig.spacingWithMenu;
  const logoPosition = ((_f = props == null ? void 0 : props.logoConfig) == null ? void 0 : _f.align) || Alignment.left;
  ...
  const languageSelectPosition = ((_x = props == null ? void 0 : props.languageConfig) == null ? void 0 : _x.align) || Alignment.right;
...
const getNavigationGridTemplateColumns = ({
  ...
  switch (logoPosition) {
    case Alignment.left:
      switch (menuPosition) {
        case Alignment.left:
          if (languageSelectPosition === Alignment.left) {
...
const getFlattenTreeActiveMenu = (originMenu, activeSlug) => {
  const cloneMenu = cloneDeep(originMenu);
...
export { calculateGrid, getFlattenTreeActiveMenu, isLightColor, splitPaddingString };
