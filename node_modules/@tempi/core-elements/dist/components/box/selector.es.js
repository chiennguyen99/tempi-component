...
import { DEFAULT_BOX } from './constants.es.js';
import { BoxQuickSetting } from './quick-setting.es.js';
import { BoxSetting } from './setting.es.js';
import { Box } from './ui.es.js';
import { Empty } from '../../core/Empty/Empty.es.js';
...
const BoxEditor = withSelector(
  (_a) => {
    var _b = _a, { children } = _b, rest = __objRest(_b, ["children"]);
    return /* @__PURE__ */ jsx(Box, __spreadProps(__spreadValues({}, rest), {
      children: children || /* @__PURE__ */ jsx(Empty, {})
    }));
  },
  {
    displayName: "Box",
    tag: Box.displayName.toLowerCase(),
    customAttributes: BoxSetting,
    advanceAttributes: AdvanceAttributes,
    quickSetting: BoxQuickSetting,
    props: DEFAULT_BOX,
    rules: {
      canMoveIn: (incomingNodes) => {
        const ignoreSources = [ColEditor.name, RowEditor.name];
