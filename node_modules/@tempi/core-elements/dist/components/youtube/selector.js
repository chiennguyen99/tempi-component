...
const YoutubeEditor = (props) => {
  ...
  if (!enabled)
    return /* @__PURE__ */ jsxRuntime.jsx(ui.Youtube, __spreadProps(__spreadValues({}, props), {
      isEditorMode: enabled
    }));
  return /* @__PURE__ */ jsxRuntime.jsx("div", {
    ref: (ref) => connect(drag(ref)),
    style: { cursor: "pointer" },
    children: /* @__PURE__ */ jsxRuntime.jsx(ui.Youtube, __spreadProps(__spreadValues({
      onClick: (e) => {
        e.preventDefault();
        track == null ? void 0 : track({
          regionName: "youtubeSetting",
...
YoutubeEditor.craft = coreEditor.crafting({
  displayName: "Youtube",
  tag: ui.Youtube.displayName.toLowerCase(),
  advanceAttributes: coreEditor.AdvanceAttributes,
  quickSetting: quickSetting.YoutubeQuickSetting,
  props: constants.DEFAULT_YOUTUBE,
  rules: {
    canDrop: (targetNode) => {
      const ignoreTargets = [
...
exports.YoutubeEditor = YoutubeEditor;
