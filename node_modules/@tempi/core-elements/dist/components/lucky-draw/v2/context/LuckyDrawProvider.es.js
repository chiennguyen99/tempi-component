...
import { LuckyDrawContext } from './LuckyDrawContext.es.js';
...
const LuckyDrawProvider = ({
  ...
  const [trigger, setTrigger] = useProp(PROP_KEY.TriggerUpdate);
  const { trackCustomEvent, upsertWheel, getWheel } = useBuilder();
  ...
  return /* @__PURE__ */ jsx(LuckyDrawContext.Provider, {
    value,
    children
  });
};

export { LuckyDrawProvider };
