...
const Accordion = (_a) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Wrapper, __spreadProps(__spreadValues({}, rest), {
    children: /* @__PURE__ */ jsxRuntime.jsx(context.AccordionProvider, {
      titleLevel,
      icon,
      children
    })
...
const Wrapper = styled__default["default"].div(
  ({ commonStyle, itemStyle, titleStyle, duration }) => {
    ...
    .accordion {
      &__item {
        ${coreRenderer.getStyle(itemStyle)}
      }
      &__title {
        h1, h2, h3, h4, h5, h6, p {
          ${coreRenderer.getStyle(titleStyle)}
        }
      }
      &__header,
      &__content  {
  ...
  utils.getAccordionItemChildrenCss
);
