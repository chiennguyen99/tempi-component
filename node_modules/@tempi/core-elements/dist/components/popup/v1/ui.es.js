...
import { unescapeString, getStyle } from '@tempi/core-renderer';
import clsx from 'clsx';
import React__default, { useState, useRef, useCallback, useEffect } from 'react';
import { WAITING_FOR_DISABLED_POPUP } from './constants.es.js';
...
const PopupV1 = React__default.forwardRef(
  (props, ref) => {
    const _a = props, {
      commonStyle,
      maskStyle,
    ...
    const [displayOnScrolToFlag, setDisplayOnScrolToFlag] = useState(false);
    const [displayOnExitFlag, setDisplayOnExitFlag] = useState(false);
    ...
    const handleOpenPopupOnExitPage = useCallback(() => {
    ...
    return /* @__PURE__ */ jsxs(Mask, {
      className: clsx([show || showPopup ? "show" : "hide", className]),
      ref: maskRef,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs(Wrapper, __spreadProps(__spreadValues({
          onClick: () => {
            var _a2, _b, _c, _d;
            if (!showPopup)
              openPopup();
          ...
          children: [
            showCloseIcon && /* @__PURE__ */ jsx(StyledIconClose, {
              style: closeIconWrapperStyle,
              onClick: handleClosePopup,
              children: /* @__PURE__ */ jsx(Icon, __spreadValues({
                name: "CloseOutlined"
              }, getPropsIcon({
...
const Mask = styled.div(({ position }) => {
  return `
  position: fixed;
  top: 0;
  left: 0;
