...
import { TabItemHead } from '../TabItemHead/TabItemHead.es.js';
...
const Tab = forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ jsxs(Wrapper, __spreadProps(__spreadValues({
      ...
      children: [
        !!tabs.length && /* @__PURE__ */ jsx(TabHeadWrapper, {
          ref: tabHeadRef,
          children: tabs.map((tab, index) => /* @__PURE__ */ jsx(TabItemHeadWrapper, {
            alignment,
            index,
            arrayLength: numberOfChildren,
            children: /* @__PURE__ */ jsx(TabItemHead, __spreadProps(__spreadValues({
              id: `tab-${index}`,
              activeColor,
              textColor,
...
const TabItemHeadWrapper = styled.div(
  ({
    alignment,
    index,
    arrayLength
