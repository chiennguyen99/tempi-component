...
import { getTargetUrl, getUrlOfMenuItem } from '../utils.es.js';
  ...
  return /* @__PURE__ */ jsx(Fragment, {
    children: /* @__PURE__ */ jsxs(StyledLabel, {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs(ItemContentWrapper, {
          alignMenu,
          hoverColor: grid.menuHoverColor,
          children: [
            /* @__PURE__ */ jsxs(ItemContent, __spreadProps(__spreadValues(__spreadValues({
              grid,
              alignMenu,
            ...
            children: (_a = item == null ? void 0 : item.children) == null ? void 0 : _a.map((child, i) => /* @__PURE__ */ jsx(Item, {
              children: /* @__PURE__ */ jsx(ItemLabel, {
                children: /* @__PURE__ */ jsx(ItemContentWrapper, {
                  alignMenu,
                  children: /* @__PURE__ */ jsxs(ItemContent, __spreadProps(__spreadValues(__spreadValues({
                    grid: __spreadProps(__spreadValues({}, grid), { menuItemSpacing: null }),
                    alignMenu,
                    target: getTargetUrl(item.target)
                  }, !isEditingMode ? {
                    href: getUrlOfMenuItem(child)
