...
const UploadFile = (props) => {
  ...
  const { env = "local" } = coreRenderer.useStore();
  ...
  const handleChange = async (event) => {
    ...
    try {
      ...
      setError(i18n.t("\u0110\xE3 x\u1EA3y ra l\u1ED7i khi upload file. Vui l\xF2ng th\u1EED l\u1EA1i."));
    } finally {
      setUploading(false);
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Wrapper, {
    ...
    children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", {
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs(StyledButton, {
            ...
            children: [
              ...
              isUploading ? i18n.t("\u0110ang t\u1EA3i l\xEAn") : i18n.t("Ch\u1ECDn t\u1EC7p tin (t\u1ED1i \u0111a {{MAX_FILE_MB_SIZE}}MB)", {
                MAX_FILE_MB_SIZE
              })
            ]
          }),
      ...
      /* @__PURE__ */ jsxRuntime.jsx("input", __spreadProps(__spreadValues({}, register ? register(name, __spreadProps(__spreadValues({}, rest), { validate: { preventSubmit } })) : __spreadValues({ name }, rest)), {
        ref,
