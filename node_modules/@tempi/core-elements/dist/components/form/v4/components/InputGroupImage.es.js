...
import { getImageUrlFromGoogleUserContent, buildSrcsetDPR, getStyle, mappingAssets } from '@tempi/core-renderer';
...
const { defaultImage, checkedInputGroupImageBkg } = mappingAssets;
const InputGroupImage = (props) => {
  ...
  return /* @__PURE__ */ jsx(Wrapper, {
    ...
    children: options.map((item) => {
      ...
      const newSrc = getImageUrlFromGoogleUserContent(image == null ? void 0 : image.src, {
        format: "webp",
        width
      });
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              /* @__PURE__ */ jsx("div", {
                ...
                children: /* @__PURE__ */ jsx("img", __spreadValues({
                  src: newSrc || defaultImage,
                  loading: "lazy",
                  alt: "form selection"
                }, newSrc && {
                  srcSet: buildSrcsetDPR(newSrc, width)
                }))
              }),
