...
import { getStyle, unescapeString } from '@tempi/core-renderer';
import clsx from 'clsx';
import React__default, { useRef, useState, useEffect } from 'react';
import ReCAPTCHA from 'react-google-recaptcha';
import { useGoogleReCaptcha, GoogleReCaptchaProvider } from 'react-google-recaptcha-v3';
import { useForm } from 'react-hook-form';
import { useForm as useForm$1 } from './hooks.es.js';
import { t } from '../../../i18n.es.js';
import { InputText } from './components/Input.es.js';
import { InputTextarea } from './components/Textarea.es.js';
import { SelectBox } from './components/SelectBox.es.js';
import { RadioGroup } from './components/RadioGroup.es.js';
import { CheckboxGroup } from './components/CheckboxGroup.es.js';
import { InputGroupImage } from './components/InputGroupImage.es.js';
import { UploadFile } from './components/UploadFile.es.js';
import { LocationSelect } from './components/LocationSelect.es.js';
...
const getErrorMessage = (type) => {
  let error = "";
  if (type === "required")
    error = t("\u0110\xE2y l\xE0 th\xF4ng tin b\u1EAFt bu\u1ED9c");
  if (type === "pattern")
    error = t("Vui l\xF2ng nh\u1EADp \u0111\xFAng \u0111\u1ECBnh d\u1EA1ng");
  return error;
};
const InnerFormV4 = React__default.forwardRef(
  (props, ref) => {
    const _a = props, {
      commonStyle,
      children,
    ...
    const { handleMultiSubmit, loading, handleSubmitFormData } = useForm$1({
      wrapperRef,
      response
    });
    ...
    const onSubmit = async (values, e) => {
      ...
      try {
        ...
        alert(t("X\xE1c minh danh t\xEDnh kh\xF4ng th\xE0nh c\xF4ng"));
        return;
      }
      try {
    ...
    const renderCaptchaCheckboxV2 = () => {
      ...
      return /* @__PURE__ */ jsx(Fragment, {
        children: captchaCheckboxV2 && /* @__PURE__ */ jsxs("div", {
    ...
    return /* @__PURE__ */ jsxs(Wrapper, {
      ...
      commonStyle,
      children: [
        /* @__PURE__ */ jsxs(Form, __spreadProps(__spreadValues({
          formStyle,
          ref,
          ...
          children: [
            (inputs || []).map((input) => {
              ...
              const renderedLabel = /* @__PURE__ */ jsx(Fragment, {
                children: showLabel && /* @__PURE__ */ jsx(StyledLabel, {
                  labelStyle,
                  className: clsx({ required: input.required }),
                  children: (input == null ? void 0 : input.label) || ""
                })
              });
              const renderedError = /* @__PURE__ */ jsx(Fragment, {
                children: error && /* @__PURE__ */ jsx(ErrorMessage, {
                  errorStyle,
                  children: getErrorMessage(error.type)
                })
              });
              if ([
                ...
                return /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    renderedLabel,
                    /* @__PURE__ */ jsx(InputText, __spreadProps(__spreadValues({
                      type: input.type,
              ...
              if (input.type === "textarea")
                return /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    renderedLabel,
                    /* @__PURE__ */ jsx(InputTextarea, __spreadProps(__spreadValues({
                      register: !isEditingMode && !!input.name && register
                    }, input), {
                      commonStyle: commonStyle2,
                      inputStyle: __spreadValues(__spreadValues({}, inputStyle || {}), input.inputStyle || {})
              ...
              if (input.type === "select-box")
                return /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    renderedLabel,
                    /* @__PURE__ */ jsx(SelectBox, __spreadProps(__spreadValues({
                      register: !isEditingMode && !!input.name && register
                    }, input), {
                      commonStyle: commonStyle2,
                      inputStyle: __spreadValues(__spreadValues({}, inputStyle || {}), input.inputStyle || {})
              ...
              if (input.type === "radio-group")
                return /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    renderedLabel,
                    /* @__PURE__ */ jsx(RadioGroup, __spreadProps(__spreadValues({
                      register: !isEditingMode && !!input.name && register
                    }, input), {
                      commonStyle: commonStyle2,
                      labelStyle,
              ...
              if (input.type === "checkbox-group-image")
                return /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    renderedLabel,
                    /* @__PURE__ */ jsx(InputGroupImage, __spreadProps(__spreadValues({
                      inputType: "checkbox",
                      register: !isEditingMode && !!input.name && register
                    }, input), {
                      commonStyle: commonStyle2,
              ...
              if (input.type === "file")
                return /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    renderedLabel,
                    /* @__PURE__ */ jsx(UploadFile, __spreadProps(__spreadValues({
                      type: input.type,
                      register: !isEditingMode && !!input.name && register
                    }, input), {
                      commonStyle: commonStyle2,
              ...
              if (input.type === "location")
                return /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    renderedLabel,
                    /* @__PURE__ */ jsx(LocationSelect, __spreadProps(__spreadValues({
                      register: !isEditingMode && !!input.name && register
                    }, input), {
                      commonStyle: commonStyle2,
                      inputStyle: __spreadValues(__spreadValues({}, inputStyle || {}), input.inputStyle || {}),
            ...
            !!hiddenFields.length && hiddenFields.map((field) => {
              if (!field.name)
                return null;
              return /* @__PURE__ */ jsx("input", __spreadProps(__spreadValues({
                type: "hidden"
              }, register(field.name)), {
                value: field.value
              }), field.name);
...
const FormV4 = React__default.forwardRef(
  (props, ref) => {
    const { captcha } = props;
    const captchav3 = (captcha == null ? void 0 : captcha.siteKey) && (captcha == null ? void 0 : captcha.version) === "invisiblev3";
    if (captchav3) {
      return /* @__PURE__ */ jsx(GoogleReCaptchaProvider, {
        reCaptchaKey: captcha.siteKey,
        children: /* @__PURE__ */ jsx(InnerFormV4, __spreadValues({
          ref
        }, props))
      });
    }
    return /* @__PURE__ */ jsx(InnerFormV4, __spreadValues({
      ref
    }, props));
  }
);
