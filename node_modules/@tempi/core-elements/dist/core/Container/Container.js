...
const Wrapper = styled__default["default"].div`
  ...
  margin-left: auto;
  position: relative;
  @media (min-width: ${grid.BREAK_POINTS.xl}) {
    max-width: ${(props) => props.fluid ? "100%" : coreRenderer.unitParse(props.maxWidth)};
  }
`;
const Container = React__default["default"].forwardRef(
  (props, ref) => {
