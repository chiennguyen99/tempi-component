import { ERROR_DESERIALIZE_COMPONENT_NOT_IN_RESOLVER } from '@tempi/dnd-utils';
import React from 'react';
import invariant from 'tiny-invariant';
import { resolveComponent } from './resolveComponent.es.js';
import { Canvas } from '../nodes/Canvas.es.js';
...
const restoreType = (type, resolver) => typeof type === "object" && type.resolvedName ? type.resolvedName === "Canvas" ? Canvas : resolver[type.resolvedName] : typeof type === "string" ? type : null;
const deserializeComp = (data, resolver, index) => {
  ...
  const jsx = __spreadValues({}, React.createElement(main, __spreadValues({}, props)));
...
export { deserializeComp, deserializeNode };
