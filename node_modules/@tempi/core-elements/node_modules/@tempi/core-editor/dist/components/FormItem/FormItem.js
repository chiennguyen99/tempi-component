...
const Tip = styled__default["default"].div`
  ...
  font-size: 13px;
`;
const WarningMessage = styled__default["default"].div`
  margin-top: 4px;
  color: #ffb307;
`;
const ErrorMessage = styled__default["default"].div`
  ...
  color: #d32f2f;
`;
const TooltipIcon = styled__default["default"](icons.QuestionCircleOutlined)`
  margin: inherit;
  margin-left: 1rem;
`;
const FormItem = (_a) => {
  ...
  const getTextElement = () => {
    if (!warning && !error && (!tip || layout !== "horizontal"))
      return null;
    const textContent = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [
        tip && layout === "horizontal" && /* @__PURE__ */ jsxRuntime.jsx(Tip, {
          children: tip
        }),
        !!warning && /* @__PURE__ */ jsxRuntime.jsx(WarningMessage, {
          children: warning
        }),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Wrapper, __spreadProps(__spreadValues({
    ...
    children: [
      !!label && /* @__PURE__ */ jsxRuntime.jsxs(Label, {
        className: "label",
        ref: getLabelWidth,
        layout,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(antd.Typography.Title, {
            level: 5,
            style: { fontSize: 14, fontWeight: 500, marginBottom: 0 },
            children: label
          }),
          !!description && /* @__PURE__ */ jsxRuntime.jsx(antd.Typography.Text, {
            type: "secondary",
            children: description
          }),
          tooltip && /* @__PURE__ */ jsxRuntime.jsx(antd.Tooltip, {
            title: tooltip,
      ...
      tip && layout === "vertical" && /* @__PURE__ */ jsxRuntime.jsx(Tip, {
        children: tip
      }),
      children,
      getTextElement()
