...
import { ROOT, COMPONENT_TAG } from './constants/root.es.js';
import { validateIsVisibleComponent } from './utils/date-time.es.js';
...
const BuilderComponent = (props) => {
  ...
  const renderComponent = (id) => {
    ...
    if ((_g = (_f = newContent == null ? void 0 : newContent[id]) == null ? void 0 : _f.children) == null ? void 0 : _g.length) {
      ...
      returnComp = React.createElement(
        comp,
        __spreadValues({
          key: id,
          ssrData: ssrData[id],
      ...
      returnComp = React.createElement(comp, __spreadValues({
        key: id,
        ssrData: ssrData[id],
  ...
  if (!(content == null ? void 0 : content[rootId]))
    return null;
  return /* @__PURE__ */ jsx(StoreProvider, __spreadProps(__spreadValues({
    mappingDynamicSlots
  }, configs), {
